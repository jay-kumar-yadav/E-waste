const Footer = () => {
  ...
  return (
    <footer className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 border-t border-gray-300" style={{ backgroundColor: '#f8f8f8' }}>
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm md:text-base text-gray-800">Follow us:</span>
